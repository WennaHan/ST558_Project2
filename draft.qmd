...
endpoint1 <- "coins/markets"
endpoint2 <- "coins/markets"
...
### Endpoint 2: Function to Get Historical Market Data for specific Cryptocurrencies
Users can modify three things:\
1) crypto_ids - List of cryptocurrencies to retrieve data for.\
2) vs_currency - Currency to compare against.\
3) days - Number of days of historical data.
```{r}
# Create a function to get historical market data for specific cryptocurrencies, allowing customization of the cryptocurrency ID and the number of days of historical data.
# The default cryptocurrencies are bitcoin, ethereum, and ripple.
# The default comparing currency is US dollar.
...
historical_data <- get_historical_market_data(crypto_id = 'bitcoin'),
                                       vs_currency = 'usd', 
                                       days = 30)
...
contingency_table <- table(crypto_data$id, crypto_data$current_price)
